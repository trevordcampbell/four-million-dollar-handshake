...
function Counter({ value, type }: { value: number, type: 'days' | 'hours' | 'minutes' | 'seconds' }) {
  ...
  return (
    <div
      style={{ fontSize }}
      className="flex space-x-1 overflow-hidden rounded-lg bg-gradient-to-tr from-white to-blue-100 px-4 leading-none text-blue-700 font-mono font-semibold border-2 border-blue-600/50"
    >
    {/* <div
      style={{ fontSize }}
...
function CounterSection({ label, value }: CounterSectionProps) {
  return (
    <div className="flex flex-col items-center">
      ...
      <span className='font-mono sm:font-semibold text-xl sm:text-base text-blue-200'>{label}</span>
...
export default function AnimatedCounter() {
  ...
  return (
    <div className='flex justify-center items-center space-x-12'>
      <p className='-mt-6 text-4xl font-display font-bold tracking-tighter text-white'>Time remaining:</p>
